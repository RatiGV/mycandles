...
class FaqController extends BaseController
{
    ...
    */
    ...
    public function __construct(Faq $model)
    {
        ...
        $this->model = $model;
        $this->routes_suffix = 'Faq';
        $this->views_folder = 'Administrator.faq';
        $this->main_table = 'faqs';
        $this->translates_table = 'faqs_translates';
    }
    ...
    protected $required_columns = ['question','answer'];

    public function index()
    {
        $this->data['listing_columns'] = ['sort', 'status','question','answer']; // <th> ელემენტები
    ...
    public function store(Request $request)
    {
        $this->validate($request,[
            'translates.'.$this->configuration->admin_lang.'.question' => 'required',
            'translates.'.$this->configuration->admin_lang.'.answer' => 'required',
        ]);
