...
class NewsController extends BaseController
{
    ...
    */
    ...
    public function __construct(News $model)
    {
        ...
        $this->categories_model = \App\Models\NewsCategories::class;
    }
    ...
    public function create()
    {
        ...
        $this->data['tags'] = Tag::allItems($this->configuration->admin_lang, $status_on = false);
        $this->data['categories'] = $this->categories_model::allItems($this->configuration->admin_lang, $status_on = false);
