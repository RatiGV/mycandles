...
class PartnersController extends BaseController
{
    ...
    */
    ...
    public function __construct(Partner $model)
    {
        ...
        $this->model = $model;
        $this->routes_suffix = 'Partners';
        $this->views_folder = 'Administrator.partners';
        $this->main_table = 'partners';
        $this->translates_table = 'partners_translates';
    }
    ...
    {
        $this->data['listing_columns'] = ['sort', 'status', 'image']; // <th> ელემენტები
