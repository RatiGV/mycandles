...
class ActorsController extends BaseController
{
    ...
    */
    ...
    public function __construct(Actors $model)
    {
        parent::__construct();

        $this->model = $model;
        $this->routes_suffix = 'Actors';
        $this->views_folder = 'Administrator.actors';
        $this->main_table = 'actors';
        $this->translates_table = 'actors_translates';
    }
