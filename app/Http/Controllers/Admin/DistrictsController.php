...
class DistrictsController extends BaseController
{
    ...
    */
    ...
    public function __construct(District $model)
    {
        ...
        $this->model = $model;
        $this->routes_suffix = 'Districts';
        $this->views_folder = 'Administrator.districts';
        $this->main_table = 'districts';
        $this->translates_table = 'districts_translates';
    }
    ...
    protected $required_columns = ['title', 'delivery_price'];
