...
class Benefit extends Model
{
    ...
    private static $translates_class = \App\Models\BenefitsTranslate::class;

    private static $main_table = 'benefits';

    private static $translates_table = 'benefits_translates';
