...
class Partner extends Model
{
    ...
    private static $translates_class = \App\Models\PartnersTranslate::class;

    private static $main_table = 'partners';

    private static $translates_table = 'partners_translates';
