...
class Tag extends Model
{
    ...
    private static $translates_class = \App\Models\TagsTranslate::class;

    private static $main_table = 'tags';

    private static $translates_table = 'tags_translates';
    ...
    {
        return $this->hasOne(TagsTranslate::class, 'parent_id', 'id')->where('lang', locale());
    }
